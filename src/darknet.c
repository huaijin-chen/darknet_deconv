...
//cc
extern void test_deconvolutional_layer();
extern void test_deconvolutional_layer_gpu();
...
int main(int argc, char **argv)
{
    ...
    if (0 == strcmp(argv[1], "average")){
        ...
        test_resize(argv[2]);
    } else if (0 == strcmp(argv[1], "cc_test_deconv")){
#ifdef GPU
        test_deconvolutional_layer_gpu();
#else
        test_deconvolutional_layer();
#endif
    } else {
